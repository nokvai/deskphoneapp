...
const webview_callflow = document.querySelector('#webview1')

webview_callflow.addEventListener('dom-ready', ()=> {
    
})
webview_callflow.addEventListener('did-stop-loading', () => {
    ...
    //webview_callflow.openDevTools()
    try { 
        webview_callflow.getWebContents().executeJavaScript(`document.querySelector('.login-message').style.display = 'none';
    ...
    webview_callflow.send("request-callflow");
});